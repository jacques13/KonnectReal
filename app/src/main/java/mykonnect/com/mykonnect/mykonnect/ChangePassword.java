...
public class ChangePassword {
    ...
    public void getData(String ID ,String password,String newPassword){
        String result = "";
        ...
        try{
            ...
            HttpPost httppost =
            new HttpPost("http://xpoliem.com/android/changepassword.php?u_id="+ID+"&password="+password+"&newPassword="+newPassword); //onthou om reg te maak
