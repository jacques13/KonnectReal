...
public class MyProfileFragment extends android.support.v4.app.Fragment implements View.OnClickListener,
    ...
    public final static String TAG = MyProfileFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String name = ((PartyHelper) getActivity().getApplication()).GetUsername();
        String icon = ((PartyHelper) getActivity().getApplication()).GetIcon();
