...
public class Register {
    ...
    public void getData(String username,String password,String email,String gender){
        String result = "";
        ...
        try{
            ...
            HttpPost httppost =
 new HttpPost("http://xpoliem.com/android/register.php?username="+username+"&password="+password+"&email="+email+"&gender="+gender); //onthou om reg te maak
