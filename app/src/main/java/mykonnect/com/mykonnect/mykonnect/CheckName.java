...
/**
 * Created by Jacques on 4/6/2015.
 */
public class CheckName {
    public boolean checkUsername(String username){
        ...
        try{
            ...
            HttpPost httppost =
                    new HttpPost("http://xpoliem.com/android/checkUsername.php?name="+username); //onthou om reg te maak
    ...
    public boolean checkEventname(String name){
        ...
        try{
            HttpClient httpclient = new DefaultHttpClient();
            HttpPost httppost =
                    new HttpPost("http://partyhelper.xpoliem.com/android/CheckEventname.php?name="+name); //onthou om reg te maak
            HttpResponse response = httpclient.execute(httppost);
            HttpEntity entity = response.getEntity();
            isr = entity.getContent();
